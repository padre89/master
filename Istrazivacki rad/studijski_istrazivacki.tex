...
%% not ted; as long as no caption text
...
%\input{poglavlja/ch_komponente.tex}
%\input{poglavlja/ch_fajlovi_u_lustre_sistemu.tex}
%\input{poglavlja/ch_kljucne_karakteristike.tex}
%\input{poglavlja/ch_predinstalacija.tex}
%\input{poglavlja/ch_instalacija.tex}
%\input{poglavlja/ch_komanda.tex} 
%\input{poglavlja/mpi_uvod.tex}
%\input{poglavlja/mpi_process_start_up.tex}
%\input{poglavlja/mpi_i_o.tex}
%\input{poglavlja/mpi_remote.tex}
%\input{poglavlja/process_management.tex}
\input{poglavlja/testiranje_performansi.tex}
